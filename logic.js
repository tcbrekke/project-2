...
var requestURL = 'https://raw.githubusercontent.com/FrankBowers24/d3-bayarea/master/Bay_Area_Cities.json';
var request = new XMLHttpRequest();
request.open('GET', requestURL);
request.responseType = 'json';
request.send();
request.onload = function() {
    var bayAreaCities = request.response;
    populateHeader(bayAreaCities);
    showHeroes(bayAreaCities);
  }
